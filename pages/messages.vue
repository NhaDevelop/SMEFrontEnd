...
const inbox = ref<any[]>([
    {
        ...
        subject: 'Q1 Financial Report Feedback',
        preview: 'We have reviewed your Q1 financial report and have some feedback...',
        content: 'Dear Team,\n\nWe have reviewed your Q1 financial report and have some feedback regarding the operational expenses. It seems there is a significant increase in marketing spend compared to the previous quarter. Could you please provide a breakdown of these costs?\n\nBest regards,\nInvestor Relations Team',
        date: '2h ago',
        fullDate: new Date(Date.now() - 7200000).toLocaleString(),
        read: false
    },
    {
        id: 2,
        sender: 'Program Manager',
        email: 'manager@programs.com',
        subject: 'Upcoming Workshop Schedule',
        preview: 'Here is the schedule for the upcoming workshops next week...',
        content: 'Hi,\n\nPlease find attached the schedule for the upcoming workshops. We have sessions on Digital Marketing and Financial Planning.\n\nLooking forward to seeing you there.\n\nBest,\nProgram Manager',
        date: 'Yesterday',
        fullDate: new Date(Date.now() - 86400000).toLocaleString(),
        read: true
    }
])
const sent = ref<any[]>([])
