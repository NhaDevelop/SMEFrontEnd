                                            ...
                                            <tr v-for="sme in filteredAvailableSmes" :key="sme.id"
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div :class="[
                                                        ...
                                                        <CheckCircleIcon v-if="selectedSmes.includes(sme.id)"
...
const getSmeStatus = (sme: any) => {
    if (!props.program) return 'Enrolled'

    // Check for matching assessment for this program's template
    const match = sme.assessments?.find((a: any) => a.templateId === props.program.templateId)
...
const getSmeProgress = (sme: any) => {
    ...
    return 0 // No progress on this template yet
}
