<template>
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6" role="dialog" aria-modal="true">
        ...
        <!-- Modal Panel -->
        <div class="relative bg-white rounded-xl shadow-xl w-full max-w-3xl overflow-hidden flex flex-col">
            <!-- Header -->
            <div class="p-8 pb-4">
                <div class="flex justify-between items-start">
                    <div>
                        <div class="flex items-center gap-3 mb-1">
                            ...
                            <span
                                :class="['px-2.5 py-0.5 rounded-full text-xs font-medium border flex items-center gap-1.5', getRiskBadgeStyles(sme.financialRisk)]">
            ...
            <div class="px-8 pb-8 space-y-8">
                <!-- Scores Row -->
                <div class="flex justify-between items-baseline bg-gray-50/50 rounded-xl p-6">
                    <div>
                ...
                <div class="flex items-center gap-3 pt-4">
                    <button
                        class="flex-1 py-2.5 bg-[#198754] text-white rounded-lg font-medium hover:bg-[#157347] transition-colors flex items-center justify-center gap-2">
                        <ArrowDownTrayIcon class="w-5 h-5" />
                        Download Report
                    </button>
                    <button @click="navigateToProfile"
                        class="flex-1 py-2.5 bg-white border border-gray-200 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition-colors">
                        View Full Profile
                    </button>
                </div>
            </div>
